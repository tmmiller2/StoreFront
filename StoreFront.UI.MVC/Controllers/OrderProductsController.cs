...
namespace StoreFront.UI.MVC.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "ProductCertified");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderProductId,ProductId,OrderId,Quantity,ProductPrice")] OrderProduct orderProduct)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "ProductCertified", orderProduct.ProductId);
            return View(orderProduct);
        }
