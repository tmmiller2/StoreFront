...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.PaintedId)
                    .HasName("PK_Colors_1");

                entity.Property(e => e.ColorName).HasMaxLength(50);

                entity.HasMany(d => d.Products)
                    .WithMany(p => p.Painteds)
                    .UsingEntity<Dictionary<string, object>>(
                        "ProductsColor",
                        l => l.HasOne<Product>().WithMany().HasForeignKey("ProductId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Colors_Products"),
                        r => r.HasOne<Color>().WithMany().HasForeignKey("PaintedId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Products_Colors_Colors"),
                        j =>
                        {
                            j.HasKey("PaintedId", "ProductId").HasName("PK_Colors");

                            j.ToTable("Products_Colors");

                            j.IndexerProperty<int>("PaintedId").ValueGeneratedOnAdd();
                        });
            });
            ...
            {
                entity.Property(e => e.ProductCertified)
                    .HasMaxLength(200)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.Status)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Products_StockStatuses");
            });
